...
public class ModelGame {
    ...
    public void assignPersonalCards() {
        try{/*code*/
            ...
            throw new ExecutionControl.NotImplementedException("Method not yet implemented");} catch (Exception ex) {System.out.println("Method not yet implemented");}
    }
    ...
    public boolean checkIfFirstToFinish(ModelPlayer firstPlayerToFinish){
        try{/*code*/ throw new ExecutionControl.NotImplementedException("Method not yet implemented");} catch (Exception ex) {System.out.println("Method not yet implemented");}
        return false;
    }
