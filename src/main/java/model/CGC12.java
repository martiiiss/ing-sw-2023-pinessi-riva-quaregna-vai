...
public class CGC12 implements CGCStrategy, Serializable {
    ...
    public boolean compareRule(Bookshelf bks, int id) {
        ...
        else if ((bookshelf[0][0].getType() != NOTHING && bookshelf[0][1].getType() == NOTHING) &&
        ...
        else if ((bookshelf[4][0].getType() == NOTHING && bookshelf[5][0].getType() != NOTHING) &&
        ...
        else if ((bookshelf[4][0].getType() != NOTHING && bookshelf[3][0].getType() == NOTHING) &&
