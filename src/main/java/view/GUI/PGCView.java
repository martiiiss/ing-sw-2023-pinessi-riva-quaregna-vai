...
public class PGCView extends JPanel implements Serializable { //manages the PersonalGoalCard section of the GUI
    ...
    public PGCView(){
        ...
        this.displayedImage = new JLabel(imageReader.readIcon("resources/PersonalGoalCardImages/back.jpg", 300, 355));
    }
    ...
    public void setDisplayedImage(int pgcId){
        ImageReader imageReader = new ImageReader();
        this.displayedImage.setIcon(imageReader.readIcon("resources/PersonalGoalCardImages/" +pgcId+".png", 300, 355));
    }
}
